  ...
  return (
    ...
    <>
      ...
      >
        ...
        <p className="cursor-pointer">DOB: {child.dateOfBirth}</p>
        <p className="cursor-pointer">Gender: {child.gender}</p>
                ...
                <div className="mt-2 flex">
                  ...
                  <div className="space-y-8">
                    <p className="text-black font-bold">Date of birth: {child.dateOfBirth}</p>
                     <p className="text-black font-bold">Gender: {child.gender}</p>
