...
function LandingPage() {
  return (
    <div className="grid grid-flow-row-dense md:grid-cols-2 lg:grid-cols-3 mx-auto md:-mt-40">
      ...
      <div className="group bg-white cursor-pointer flex flex-col m-5 z-30 p-5 transition
        ...
        <Link href="/about">
          <button className="mr-56 mt-4 button w-200 hover:animate-bounce">learn more</button>
        </Link>
      </div>
      ...
      <div className="group bg-white cursor-pointer flex flex-col m-5 z-30 p-5 transition
        ...
        <ul className="m-4 mr-8">
          <Link href="/discipleship">
            <li className="font-bold text-xl text-blue-600 hover:text-scu_blue-light hover:underline">Discipleship & Evangelism</li>
          </Link>
          <Link href="/education">
            <li className="font-bold text-xl text-blue-600 hover:text-scu_blue-light hover:underline">Education Support</li>
          </Link>
          <Link href="/skills">
            <li className="font-bold text-xl text-blue-600 hover:text-scu_blue-light hover:underline">Skilling</li>
          </Link>
          <Link href="/crisis-care">
            <li className="font-bold text-xl text-blue-600 hover:text-scu_blue-light hover:underline">Crisis care & Management</li>
          </Link>          
        </ul>
      </div>
      ...
      <div className="group bg-white cursor-pointer flex flex-col m-5 z-30 p-5 transition
        ...
        <Link href="/participate">
          <button className="mr-56 mt-4 button hover:animate-bounce">learn how</button>
        </Link>
      </div>
