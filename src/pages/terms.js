...
function PrivacyPolicy() {
  ...
  return (
    <div className="bg-gray-300">
      <Head>
        <title>Smile Charity Uganda Terms of Service</title>
        <link
      ...
      <main className="max-w-screen-xl mx-auto">
        ...
        <div className="ml-4 mb-4 mt-2" data-aos="slide-up">
          ...
          <p>
            We are responsible for information made available on this site. If
            the information is not accurate, complete or current you may contact
            us. The material on this site is provided for general information
            only and should be relied upon or used as the sole basis for making
            decisions with consulting primary, more accurate, more complete or
          ...
          <p data-aos="slide-up" className="ml-2">
            ...
            regulations, rules, laws, or local ordinances; <br /> (d) to
            ...
            <br /> (f) to submit false or misleading information; <br />
            ...
            other websites, or the Internet; <br />
