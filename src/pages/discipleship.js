      ...
      <main className="max-w-screen-2xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="absolute -mt-44 px-10">
              ...
              <p className="hidden lg:block text-scu_blue-light text-xl text-left px-2 font-bold">
                ...
                our programs through visiting us here on the ground,
                volunteering with our programs of your choice.
              </p>
            </div>
          </div>
        ...
        duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105"
            >
              ...
              <p>
                ...
                empowered and transformed lives through our working mechanism
                DESC which stands for Discipleship and Evangelism, Education
                Support, Skilling and Crisis management.
              </p>
              <Link href="/about">
        ...
        duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105"
            >
              ...
              <p>
                You too can be part of this work through praying with us,
                Visiting us, or donating to us.
              </p>
