      ...
      <div className="flex bg-scu_blue-light items-center flex-col sm:flex-grow justify-between lg:flex-row">
        ...
        <div className="flex justify-evenly space-x-4 last:ml-10 max-w-2xllg">
          ...
          <div className=" flex space-x-6">
            <Link href="mailto:info@smilecharityuganda.org" passHref={true}>
              <a href="mailto:info@smilecharityuganda.org" target="_blank">
        ...
        <ul className="flex whitespace-nowrap ml-4 items-center justify-evenly flex-grow">
                {
                  helperdata.map((item, index)=>{
                    return(
                      <li key={index} className="hover:scale-105 flex-row cursor-pointer p-1 pr-2 rounded-md
